...
// Download a styled Excel export generated by the backend
export async function exportAuditsExcel(payload = {}) {
  const resp = await axios.post(`${API_BASE}/admin/audits/export`, payload, {
    responseType: "blob",
    withCredentials: true,
  });
  return resp.data;
